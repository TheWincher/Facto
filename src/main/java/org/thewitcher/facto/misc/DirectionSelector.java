...
public class DirectionSelector {
    ...
    public AbstractWidget getButton(int x, int y) {
        return new ExtendedButton(x, y, 100, 20, Component.translatable("info." + Facto.MODID + ".populate"), button ->
            ...
            public Component getMessage() {
                ...
                var msg = Component.translatable("dir." + Facto.MODID + "." + (dir != null ? dir.getName() : "all"));
                if (dir != null) {
