...
public class PacketButton {
    ...
    public enum ButtonResult {
        ...
        FILTER_CHANGE((pos, data, player) -> {
            if (player.containerMenu instanceof ItemFilter.IFilteredContainer filtered)
...
//        }),
        ...
        DIRECTION_SELECTOR((pos, data, player) -> {
            if (player.containerMenu instanceof DirectionSelector.IDirectionContainer filtered)
